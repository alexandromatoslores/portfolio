...
export function ModeToggle() {
  ...
  // 👇 cambio: estado mounted para evitar hydration error
      ...
      >
        ...
        >
          <m.path
            ...
            animate={{ fillOpacity: 0.35, strokeOpacity: 1 }}
            d={mounted && theme === "dark" ? moonPath : sunPath} // 👈 cambio exacto
          />

          <m.g
            variants={raysVariants}
            initial="hidden"
            animate={mounted && theme === "light" ? "visible" : "hidden"} // 👈 también controlado por mounted
          >
            <m.path variants={rayVariant} d="M20 0.833333V4.66667" />
            <m.path variants={rayVariant} d="M20 35.3333V39.1667" />
            <m.path variants={rayVariant} d="M6.44917 6.44917L9.15167 9.15167" />
            <m.path variants={rayVariant} d="M30.8483 30.8483L33.5508 33.5508" />
            <m.path variants={rayVariant} d="M0.833332 20H4.66667" />
            <m.path variants={rayVariant} d="M35.3333 20H39.1667" />
            <m.path variants={rayVariant} d="M9.15167 30.8483L6.44917 33.5508" />
            <m.path variants={rayVariant} d="M33.5508 6.44917L30.8483 9.15167" />
          </m.g>
        </m.svg>
      </Button>
    </div>
  ...
  // 👇 resto del menú de selección de tema
  return (
    <DropdownMenu>
